...
train_eval_forecast(){
  python rnn_train.py --epochs 1 --model-name test_wt --variable wt --csv-name $1 --network $2
...
train_eval_forecast POSE_waterT_data lstm
train_eval_forecast POSE_waterT_data gru
train_eval_forecast BARC_waterT_data lstm
train_eval_forecast BARC_waterT_data gru
